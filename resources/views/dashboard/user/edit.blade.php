                  ...
                  <form method="post" action="{{ url('/users/'.$data->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="phone" name="phone" value="{{$data->nohp}}">
                        </div>
                        <div class="col-md-6">
                            <label for="name" class="form-label">Nama Pelatih</label>
                            <input type="text" class="form-control" id="nama_pelatih" name="nama_pelatih" value="{{$data->nama_pelatih}}">
                        </div>
                        <div class="col-md-6">
